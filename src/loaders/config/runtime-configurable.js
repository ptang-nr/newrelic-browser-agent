...
import { BUILD_ENV, DIST_METHOD, VERSION } from '../../common/constants/env'
import { globalScope } from '../../common/constants/runtime'

export class RuntimeConfigurable extends Configurable {
  buildEnv = BUILD_ENV
  ...
  /**
   * Constructs a new configurable instance using the runtime config model.
   * @param {Exclude<RuntimeConfigurable, 'update'>=} input Base runtime config options to apply
